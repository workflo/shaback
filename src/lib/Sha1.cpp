...
void Sha1::update(const unsigned char* data, unsigned long len)
{
...
{
  SHA1_Update(ctx, (const unsigned char*) data.data(), data.size());
}
...
void Sha1::finalize()
{
  ...
  // Taken on 2016/06/17 from http://download.redis.io/redis-stable/src/sha1.c
